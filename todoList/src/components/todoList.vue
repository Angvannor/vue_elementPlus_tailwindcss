<template>
  <div class="shadow-lg w-full h-7/8 rounded-xl p-5">
    ...
    <el-table :data="data" border max-height="320px" style="width: 100%">
      <el-table-column prop="name" label="名称" width="100" />
      <el-table-column prop="region" label="类别" width="60" />
...
const data = ref([
  ...
  },
  {
    name: "阅读技术书籍",
    region: "兴趣",
    desc: "阅读《JavaScript高级程序设计》和《你不知道的JavaScript》系列。",
  },
  {
    name: "锻炼身体",
    region: "兴趣",
    desc: "每天跑步30分钟，保持身体健康。",
  },
  {
    name: "学习Vue3",
    region: "事业",
